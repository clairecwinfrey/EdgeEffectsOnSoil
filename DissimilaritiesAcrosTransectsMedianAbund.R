...
ASVsdf <- ASVs_outta_ps(medianEU.ps) #get ASV table using functioned defined earlier; samples are rows, ASVs = columns
metaDf <- metadata_outta_ps(medianEU.ps) #get metadata using function defined earlier; samples are rows
